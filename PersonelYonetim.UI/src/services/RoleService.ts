...
class RoleService {
  ...
  async rolCreate(request: PozisyonCreateRequest): Promise<string> {
  ...
  async rolrUpdate(id: string, request: PozisyonCreateRequest): Promise<string> {
    request.id = id;
  ...
  async rolDelete(id: number): Promise<string> {
