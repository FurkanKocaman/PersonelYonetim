...
<template>
  <div class="container mx-auto px-4 py-8">
    <div class="mb-6">
      ...
      <p class="text-gray-600 dark:text-gray-400">Sistem ve kullanıcı ayarlarını yönetin</p>
    </div>
    ...
    <div v-else>
      <!-- Başarı Mesajı -->
      <div v-if="savedMessage" class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-6">
        ...
        <ul class="flex flex-wrap -mb-px">
          <li class="mr-2">
            <button 
              ...
              :class="activeTab === 'genel' ? 'text-sky-600 border-sky-600' : 'text-gray-500 border-transparent hover:text-gray-600 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300'"
            >
          ...
          <li class="mr-2">
            <button 
              ...
              class="inline-block py-4 px-4 text-sm font-medium text-center border-b-2 rounded-t-lg"
              :class="activeTab === 'kullanici' ? 'text-sky-600 border-sky-600' : 'text-gray-500 border-transparent hover:text-gray-600 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300'"
            >
          ...
          <li class="mr-2">
            <button 
              ...
              class="inline-block py-4 px-4 text-sm font-medium text-center border-b-2 rounded-t-lg"
              :class="activeTab === 'guvenlik' ? 'text-sky-600 border-sky-600' : 'text-gray-500 border-transparent hover:text-gray-600 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300'"
            >
      ...
      <div class="bg-white dark:bg-neutral-800 rounded-lg shadow p-6">
        ...
        <div v-if="activeTab === 'genel'" class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Şirket Adı</label>
              <input 
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Varsayılan Dil</label>
              <select 
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tarih Formatı</label>
              <select 
        ...
        <div v-if="activeTab === 'guvenlik'" class="space-y-6">
          ...
          <div class="space-y-4">
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">İki Faktörlü Doğrulama</label>
              <div class="mt-2">
                <label class="inline-flex items-center">
                  <input 
                    ...
                    class="rounded border-gray-300 text-sky-600 shadow-sm focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50"
                  >
                  <span class="ml-2 text-gray-700 dark:text-gray-300">İki faktörlü doğrulamayı etkinleştir</span>
                </label>
              </div>
            </div>
            
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Oturum Zaman Aşımı (dakika)</label>
              <input 
        ...
        <div v-if="activeTab === 'bildirimler'" class="space-y-6">
          ...
          <div class="space-y-4">
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">E-posta Bildirimleri</label>
              <div class="mt-2">
                <label class="inline-flex items-center">
                  <input 
                    ...
                    class="rounded border-gray-300 text-sky-600 shadow-sm focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50"
                  >
                  <span class="ml-2 text-gray-700 dark:text-gray-300">E-posta bildirimlerini etkinleştir</span>
                </label>
              </div>
            </div>
            
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tarayıcı Bildirimleri</label>
              <div class="mt-2">
                <label class="inline-flex items-center">
                  <input 
                    ...
                    class="rounded border-gray-300 text-sky-600 shadow-sm focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50"
                  >
                  <span class="ml-2 text-gray-700 dark:text-gray-300">Tarayıcı bildirimlerini etkinleştir</span>
                </label>
              </div>
            </div>
            
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Mobil Bildirimleri</label>
              <div class="mt-2">
                <label class="inline-flex items-center">
                  <input 
                    ...
                    class="rounded border-gray-300 text-sky-600 shadow-sm focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50"
                  >
                  <span class="ml-2 text-gray-700 dark:text-gray-300">Mobil bildirimlerini etkinleştir</span>
                </label>
              </div>
            </div>
          </div>
