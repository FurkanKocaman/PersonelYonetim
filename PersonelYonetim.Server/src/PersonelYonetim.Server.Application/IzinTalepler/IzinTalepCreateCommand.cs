...
//                        if (baslangicGun == baslangic.Date && baslangic.TimeOfDay > (calismaGun.CalismaBaslangic ?? new TimeOnly(0,0)).ToTimeSpan())
//                        {
//                            if (baslangic.TimeOfDay <= (calismaGun.CalismaBitis ?? new TimeOnly(18, 0)).ToTimeSpan())
//                            {
//                                toplamGun += (decimal)((calismaGun.CalismaBitis?.ToTimeSpan() - baslangic.TimeOfDay)?.TotalHours ?? 0) / 9;
//                            }
//                        }
//                        else if (baslangicGun == bitis.Date && bitis.TimeOfDay < (calismaGun.CalismaBitis?.ToTimeSpan() ?? TimeSpan.FromHours(18)))
//                        {
//                            toplamGun += (decimal)((bitis.TimeOfDay - calismaGun.CalismaBaslangic?.ToTimeSpan())?.TotalHours ?? 0) / 9;
//                        }
//                        else
//                        {
//                            toplamGun += 1;
...
//                {
//                    if (bitis.TimeOfDay < (izinBitisGun.CalismaBitis?.ToTimeSpan() ?? new TimeOnly(18,0).ToTimeSpan()))
//                    {
...
//                            }
//                            mesaibaslangic = mesaibaslangic.DateTime.Add(sonrakiCalismaGun.CalismaBaslangic?.ToTimeSpan() ?? TimeSpan.FromHours(9));
//                        }
//                    }
//                }
//                else
